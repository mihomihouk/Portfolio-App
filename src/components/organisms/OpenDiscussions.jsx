...
import { Box, Button, Card, CardContent, Divider, List, ListItem, ListItemText, Paper, Typography } from '@mui/material'
    ...
    <>
       <Box>
        <Box sx={{display:"flex", alignItems:"center", justifyContent:"space-between", pb:1}}>
          <Typography variant="h5" component="h2">Open Discussions</Typography>
        ...
        <Card raised sx={{borderRadius:"25px"}}>
          ...
          {!isPending && !documents && <Typography>No projects yet!</Typography>}
          {documents && <List sx={{height:"20%", width:"100%"}}>
            {documents.map(item => (
